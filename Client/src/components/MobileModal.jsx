...
const MobileModal = ({ visa, modalOpen, setModalOpen }) => {
  const {
    _id,
    countryImage,
    countryName,
  ...
  return (
    <>
      <div
        ...
        } w-full h-screen fixed top-0 left-0 z-50 bg-[#0000002a] p-3 flex items-center justify-center transition-all duration-300`}
      >
        <div
          className={`${
        ...
        >
          ...
          <div className="w-full ">
            <form onSubmit={handleUpdateFrom} className="gird overflow-hidden">
              {/* 1 */}
              <div>
